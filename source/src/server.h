...
{ //  name                      desc                    vol, loop, rad, key,                 flags
    ...
    { "voicecom/awesome_2", "Awesome (2)", 0, 0, 0, S_AWESOME2, C(VOICECOM)|C(TEAM)|C(PUBLIC) },
    ...
    { "ktf/flagscore",          "KTF score",                0, 0,  0, S_KTFSCORE,               C(OTHER)         }, // 101 C(OTHER) }, 
    { "misc/camera",         	"Screenshot",               0, 0,  0, S_CAMERA,                 C(OTHER)         },  // 102,      C(OTHER) },
    { "misc/dub", "Double Kill", 100, 0, 0, S_DUB, C(OTHER) },
    { "misc/tub", "Triple Kill", 100, 0, 0, S_TRIPLEKILL, C(OTHER) },
    { "misc/mub", "Multi Kill", 100, 0, 0, S_MULTIKILL, C(OTHER) },
    { "misc/msub", "Monster Kill", 100, 0, 0, S_MONSTERKILL, C(OTHER) },
    { "misc/unub", "Unstoppable", 100, 0, 0, S_UNSTOPPABLE, C(OTHER) },
    { "misc/gum", "Godlike", 100, 0, 0, S_GODLIKE, C(OTHER) },	
};
#undef C
